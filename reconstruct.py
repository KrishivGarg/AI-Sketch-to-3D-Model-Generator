...
# ── settings ──────────────────────────────────────────────────────────────────
TRIPO_API_KEY    = "tsk_FPtU1DOSOUugiNmS00oUF0XA6hJHJd1uCX_N5tmeFJ8"   # ← paste your key here
...
def _prepare_image(frame: np.ndarray) -> Image.Image:
    ...
    # Paste onto white 512x512 canvas
    size   = 512
    ...
    # Save debug preview so you can inspect what Tripo receives
